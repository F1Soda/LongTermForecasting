...
def annualized_returns(series, years):
    ...
    узнать среднегодовую доходность всех периодов удержания
    длиной 10 лет.

    :param series:
        Pandas Series, например, с совокупной доходностью акции.
        Предполагается, что данные представлены по дням.

    :param years:
        Количество лет в каждом периоде.
...
def plot_ann_returns(ticker, df, years,
    ...
    """
    Создаем график с фактическими историческими доходностями,
